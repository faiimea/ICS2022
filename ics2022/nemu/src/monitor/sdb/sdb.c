...
//faii
//int (*handler)(char *) -> func
//cmd_c return 0 then cmd_q return -1
...
// About memory set
// word_t=uint32_t(RISCV32) or uint64(RISCV64)
// vaddr_t=word_t (virtual address)
...
static int cmd_x(char *args){
  ...
  if (arg1 == NULL) {
    printf("Usage: loss of arg1\n");
    return 0;
  }
  char *arg2 = strtok(NULL, " ");
  if (arg2 == NULL) { 
    printf("Usage: loss of arg2\n");
    return 0;
  }
  int len;
  vaddr_t address;
